    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          label="resourceId">
          <a-input placeholder="请输入resourceId" v-decorator="['resourceId', validatorRules.resourceId ]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
  ...
  export default {
    ...
    data () {
      return {
        ...
        validatorRules:{
        resourceId:{rules: [{ required: true, message: '请输入resourceId!' }]},
        },
        url: {
          add: "/frontend/resource/add",
          edit: "/frontend/resource/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'resourceId','type','url'))
		  //时间格式化
